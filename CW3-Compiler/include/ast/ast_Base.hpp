...
void push_Stack () {
        ...
        cout << "sw $31,12($sp)"<<endl;
        cout << "sw $fp, 8($sp) #Old frame pointer 2 blocks down " << endl; // store prev frame poitner (4 offset
// MEM [sp + 4 ] = $fp)
...
void endFunction (string fName,Stack* stPtr) {
        ...
        cout << "lw $31,12($sp)"<<endl;
        stPtr->storeLoad("lw","fp","8($sp) #Load old frame pointer 2 blocks down"); //load old frame pointer 2 blocks down
